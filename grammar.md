...
| Akkusativ: der→den / ein→einen + pronombres (mich/dich/ihn…) (`akkusativ`) | introduced@5 practicing@5 | s5 100%/100%. Masculino sólido; la **terminación femenina de ein-/kein- (eine/keine)** aún se resbala (ver weak-spot `case` s6). Sigue **practicing**. Ref: `grammar/akkusativ.md` |
| Negation: `kein` (declina como ein-) vs `nicht` (`negation-kein-nicht`) | introduced@6 practicing@6 | s6: ej-01 83% / ej-02 90%. Lógica kein/nicht dominada; a pulir: femenino *keine* + posición de *nicht* (ver weak-spots). Ref: `grammar/negation-kein-nicht.md` |
