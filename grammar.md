...
| topic | state(s) | notes |
|---|---|---|
| Präsens: `sein` + Personalpronomen + V2 + W-Fragen (`praesens-sein-personalpronomen`) | introduced@1 practicing@1 mastered@3 **practicing@10** | 95% s1; s3 sein 4/4 + `ihr seid` cleared → mastered@3. **s10: DEMOTADO a `practicing`** — el sondeo espaciado del 00-check falló (*Seind ihr müde?* → *Seid*); recaída de `ihr seid`. A recircular. (W-Frage *Woher* s10 ✓.) Ref: `grammar/praesens-sein-personalpronomen.md` |
...
| Modalverben: können/müssen/wollen/dürfen/sollen/mögen (+möchten) + Satzklammer (`modalverben`) | introduced@8 practicing@8 | s8: ej-01 **100%** / ej-02 **90%** / ej-03 **88%**. Satzklammer sólida; pendiente *du* en pregunta invertida (*Kannst du*, recurre s9) y léxico kaufen/zahlen. **practicing**. Ref: `grammar/modalverben.md` |
| Possessivartikel: mein/dein/sein/ihr… (declinan como ein-/kein-) (`possessivartikel`) | introduced@9 practicing@9 | s9: ej-01 83% / ej-02 80% / ej-03 **100%**. Mecánica y sein/ihr sólidos; **-en de más** fuera de masc-Akk (meinen Schuhe/deinen Pullover/einen Hose) = vaivén → weak-spot `case`. **practicing**. Ref: `grammar/possessivartikel.md` |
| Imperativ: du/ihr/Sie + `sei/seid/seien Sie` + separables (`imperativ`) | introduced@10 practicing@10 | s10: ej-01 **100%** / ej-02 **92%** / ej-03 **67%** (el dip NO es del tema — son weak-spots viejos interleaved: -en de más, dativo, vocab). Morfología sólida: e→i/ie conservado (*Nimm/Gib/Sprich/Lies*), a→ä NO (*Fahr/Schlaf*), *Sei* irregular, separables (*Kauf ein!*), imperativos correctos en escritura libre. Pendiente: **-e obligatoria tras -t** (*Wart→Warte*) y **orden con Sie** (*Helfen Sie mir*). **practicing**. Ref: `grammar/imperativ.md` |
